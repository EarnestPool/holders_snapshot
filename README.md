You can use the following code in order to create a dictionary of unique wallets and the assets they hold for the NFT project of interest on Cardano blockchain.\
